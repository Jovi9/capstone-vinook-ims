...
Public Class reportOrdersAll
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ViNOOK_IMS.reportOrdersAll.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedreportOrdersAll
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As reportOrdersAll = New reportOrdersAll()
        rpt.Site = Me.Site
        Return rpt
    End Function
