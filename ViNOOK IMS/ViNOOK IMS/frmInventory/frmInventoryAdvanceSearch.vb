Public Class frmInventoryAdvanceSearch

    Public Sub loadDataGrid()
        Dim funcInventory As New inventoryFunction
        funcInventory.advanceSearchInventory(xDataGrid, txt_searchbox.Text)
    ...
    Private Sub xDataGrid_CellClick(sender As Object, e As DataGridViewCellEventArgs) Handles xDataGrid.CellClick
        Try
            If xDataGrid.Columns(e.ColumnIndex).HeaderText = "Action" Then
                frmViewStockDetails.txtReference.Text = xDataGrid.CurrentRow.Cells("_reference").Value
...
#End Region
    ...
    Private Sub frmInventoryAdvanceSearch_Load(sender As Object, e As EventArgs) Handles Me.Load
        setDoubleBuffer(xDataGrid)
        txt_searchbox.Select()
    End Sub

    Private Sub frmInventoryAdvanceSearch_KeyDown(sender As Object, e As KeyEventArgs) Handles Me.KeyDown
