...
Public Class reportInventoryAll
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ViNOOK_IMS.reportInventoryAll.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedreportInventoryAll
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As reportInventoryAll = New reportInventoryAll()
        rpt.Site = Me.Site
        Return rpt
    End Function
